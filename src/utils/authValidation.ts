...
export const registerValidation = [
  body('firstName', 'First Name should contain at least two letters').isLength({ min: 2 }),
  body('lastName', 'Last Name should contain at least two letters').isLength({ min: 2 }),
